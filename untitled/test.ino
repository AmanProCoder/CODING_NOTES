...
#define LED_PIN   27 //Pin for the pixel strand. Can be analog or digital.
#define LED_TOTAL 25 //Change this to the number of LEDs in your strand.
...
//  knob = analogRead(KNOB_PIN) / 1023.0; //Record how far the trimpot is twisted
 ...
 volume = random(0,1023);       //Record the volume level from the sound detector
  knob = 800 / 1023.0; //Record how far the trimpot is twisted
